...
namespace CItyTrafficSimulator.Classes
{
    public class TrafficLightsList
    {
        ...
        public TrafficLightsList(ExpWithoutAlgWindow expWithoutAlgWindow)
        {
            ...
            AllTraficLights.Add(new TrafficLights() { GreenLight = _expWithoutAlgWindow.Green27, RedLight = _expWithoutAlgWindow.Red27, YellowLight = _expWithoutAlgWindow.Yellow27, TimeOfGreenLight = 30, TimeOfRedLight = 30, TimeOfYellowLight = 2 }); //światła na skrzyżowaniu Opata Jacka Rybinskiego z Polanki w stronę Przymorza
            ...
            AllTraficLights.Add(new TrafficLights() { GreenLight = _expWithoutAlgWindow.Green35, RedLight = _expWithoutAlgWindow.Red35, YellowLight = _expWithoutAlgWindow.Yellow35, TimeOfGreenLight = 30, TimeOfRedLight = 30, TimeOfYellowLight = 2 }); //światła na skrzyżowaniu Opata Jacka Rybińskiego z Polanki w stronę Osowy
            AllTraficLights.Add(new TrafficLights() { GreenLight = _expWithoutAlgWindow.Green36, RedLight = _expWithoutAlgWindow.Red36, YellowLight = _expWithoutAlgWindow.Yellow36, TimeOfGreenLight = 30, TimeOfRedLight = 30, TimeOfYellowLight = 2 }); //światła na skrzyżowaniu Grunwaldzkiej z Opata Jacka Rybińskiego
            AllTraficLights.Add(new TrafficLights() { GreenLight = _expWithoutAlgWindow.Green37, RedLight = _expWithoutAlgWindow.Red37, YellowLight = _expWithoutAlgWindow.Yellow37, TimeOfGreenLight = 60, TimeOfRedLight = 30, TimeOfYellowLight = 2 }); //światła na skrzyżowaniu Grunwaldzkiej z Derdowskiego w stronę Gdańska
            AllTraficLights.Add(new TrafficLights() { GreenLight = _expWithoutAlgWindow.Green38, RedLight = _expWithoutAlgWindow.Red38, YellowLight = _expWithoutAlgWindow.Yellow38, TimeOfGreenLight = 60, TimeOfRedLight = 30, TimeOfYellowLight = 2 }); //światła na skrzyżowaniu Grunwaldzkiej z Derdowskiego w stronę Sopotu
