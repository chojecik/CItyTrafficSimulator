    ...
    public class RouteList
    {
        ...
        public RouteList(ExpWithoutAlgWindow expWithoutAlgWindow)
        {
           ...
           /* routes.Add(new Route() { Id = 10, StartPoint = new Point(50, 10), EndPoint = new Point(970, 771), OccupancyRate = 6, TrafficLightsOnRoute = new List<TrafficLights>() { trafficLightsList.AllTraficLights[0], trafficLightsList.AllTraficLights[29], trafficLightsList.AllTraficLights[36], trafficLightsList.AllTraficLights[37], trafficLightsList.AllTraficLights[21], trafficLightsList.AllTraficLights[14], trafficLightsList.AllTraficLights[12], trafficLightsList.AllTraficLights[11] }, StartingDirection = Direction.South });*/ //Trasa Pomorska - Aleja Żołnierzy wyklętych w stronę Niedźwiednika przez Grunwaldzką
            ...
            routes.Add(new Route() { Id = 14, StartPoint = new Point(1174, 330), EndPoint = new Point(549, 10), OccupancyRate = 5, TrafficLightsOnRoute = new List<TrafficLights>() { trafficLightsList.AllTraficLights[7], trafficLightsList.AllTraficLights[39], trafficLightsList.AllTraficLights[5]}, StartingDirection = Direction.West });//Trasa Grunwaldzka - Kołobrzeska z Gdańska
            routes.Add(new Route() { Id = 15, StartPoint = new Point(10, 370), EndPoint = new Point(549, 10), OccupancyRate = 5, TrafficLightsOnRoute = new List<TrafficLights>() { trafficLightsList.AllTraficLights[31], trafficLightsList.AllTraficLights[29], trafficLightsList.AllTraficLights[36], trafficLightsList.AllTraficLights[37], trafficLightsList.AllTraficLights[21] }, StartingDirection = Direction.East });//Trasa Grunwaldzka - Kołobrzeska z Gdańska
            routes.Add(new Route() { Id = 16, StartPoint = new Point(990, 771), EndPoint = new Point(990, 10), OccupancyRate = 6, TrafficLightsOnRoute = new List<TrafficLights>() { trafficLightsList.AllTraficLights[9], trafficLightsList.AllTraficLights[8]}, StartingDirection = Direction.North });//Trasa Aleja Żołnierzy Wyklętych w strone Zaspy
            routes.Add(new Route() { Id = 17, StartPoint = new Point(945, 10), EndPoint = new Point(945, 771), OccupancyRate = 6, TrafficLightsOnRoute = new List<TrafficLights>() { trafficLightsList.AllTraficLights[6], trafficLightsList.AllTraficLights[11] }, StartingDirection = Direction.South });//Trasa Aleja Żołnierzy Wyklętych w strone Niedźwiednika
            routes.Add(new Route() { Id = 18, StartPoint = new Point(945, 10), EndPoint = new Point(10, 330), OccupancyRate = 6, TrafficLightsOnRoute = new List<TrafficLights>() { trafficLightsList.AllTraficLights[6], trafficLightsList.AllTraficLights[5], trafficLightsList.AllTraficLights[38], trafficLightsList.AllTraficLights[3], trafficLightsList.AllTraficLights[1] }, StartingDirection = Direction.South });//Trasa Aleja Żołnierzy Wyklętych Od Zaspy Do Grunwaldzkiej w stronę Sopotu
            routes.Add(new Route() { Id = 19, StartPoint = new Point(945, 10), EndPoint = new Point(1174, 370), OccupancyRate = 6, TrafficLightsOnRoute = new List<TrafficLights>() { trafficLightsList.AllTraficLights[6]}, StartingDirection = Direction.South });//Trasa Aleja Żołnierzy Wyklętych Od Zaspy Do Grunwaldzkiej w stronę Gdańska
            routes.Add(new Route() { Id = 20, StartPoint = new Point(990, 771), EndPoint = new Point(10, 330), OccupancyRate = 6, TrafficLightsOnRoute = new List<TrafficLights>() { trafficLightsList.AllTraficLights[9], trafficLightsList.AllTraficLights[8], trafficLightsList.AllTraficLights[5], trafficLightsList.AllTraficLights[38], trafficLightsList.AllTraficLights[3], trafficLightsList.AllTraficLights[1] }, StartingDirection = Direction.North });//Trasa Aleja Żołnierzy Wyklętych od Niedźwiednika do Grunwaldzkiej w stronę Sopotu
            routes.Add(new Route() { Id = 21, StartPoint = new Point(990, 771), EndPoint = new Point(1174, 370), OccupancyRate = 6, TrafficLightsOnRoute = new List<TrafficLights>() { trafficLightsList.AllTraficLights[9], trafficLightsList.AllTraficLights[8] }, StartingDirection = Direction.North });//Trasa Aleja Żołnierzy Wyklętych od Niedźwiednika do Grunwaldzkiej w stronę Gdańska
