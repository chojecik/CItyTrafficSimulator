...
namespace CItyTrafficSimulator.Classes
{
    public class RouteList
    {
        ...
        public RouteList(ExpWithoutAlgWindow expWithoutAlgWindow)
        {
            ...
            routes.Add(new Route() { Id = 2, StartPoint = new Point(10, 355), EndPoint = new Point(1174, 355), OccupancyRate = 2, TrafficLightsOnRoute = new List<TrafficLights>() { trafficLightsList.AllTraficLights[0] } }); //Trasa Grunwaldzka w stronę Gdanska
            routes.Add(new Route() { Id = 3, StartPoint = new Point(1174, 330), EndPoint = new Point(10, 330), OccupancyRate = 2, TrafficLightsOnRoute = new List<TrafficLights>() { trafficLightsList.AllTraficLights[0] } }); //Trasa Grunwaldzka w stronę Sopotu
